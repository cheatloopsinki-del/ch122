...
const TermsOfServicePage = () => {
  ...
  const getContent = () => {
    if (lang === 'ar') return settings.terms_of_service_ar || settings.terms_of_service;
    if (lang === 'tr') return settings.terms_of_service_tr || settings.terms_of_service;
    if (lang === 'ru') return settings.terms_of_service_ru || settings.terms_of_service;
    return settings.terms_of_service_en || settings.terms_of_service;
  };
