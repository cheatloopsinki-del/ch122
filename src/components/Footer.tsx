        ...
        <div className="grid md:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-slate-400">
              ...
              <li><a href="/shop" className="hover:text-cyan-400 transition-colors">CheatLoop Shop</a></li>
              ...
              <li><a href="/contact" className="hover:text-cyan-400 transition-colors">Contact CheatLoop</a></li>
            </ul>
          </div>
